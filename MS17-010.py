...
def check(ip, port=445):
	...
	print '# 0xC0000205 - STATUS_INSUFF_SERVER_RESOURCES - vulnerable'
        print '# 0xC0000008 - STATUS_INVALID_HANDLE'
        print '# 0xC0000022 - STATUS_ACCESS_DENIED'

	print '=========== result ============'

	print repr(nt_status)
